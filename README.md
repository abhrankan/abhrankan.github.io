...
This repository contains my personal portfolio website, highlighting selected work in mathematics, algorithm design, and software development.

## Overview

The portfolio features:
- An embedded **Sudoku Solver** (via GitHub Gist)  
- Algorithmic and number-theoretic projects  
- Interactive mathematical tools  
- A clean, minimal, responsive design  
